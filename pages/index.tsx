    ...
    <>
      ...
      <div className="flex items-center justify-center h-screen bg-gray-700">
        <form onSubmit={handleSubmit}>
          <div className="rounded-lg border shadow-md bg-gray-800 border-gray-700 flex flex-col items-center justify-center px-32 py-24">
            <label
              htmlFor="input-group-1"
              className="block mb-3 text-xl font-bold text-gray-300"
            >
              Enlace a cortar
            </label>
